...
public class CswBkg1SqlIT {
    ...
    public CswBkg1SqlIT( String testLabel, String resultSnippet, boolean isCSWAvailable) {
    ...
    public static Collection<Object[]> getResultSnippets()
        ...
        URL url = CswBkg1SqlIT.class.getResource( "/bkg1/ctl/sql/" );
    ...
    private static boolean isCSWAvailable() {
        String url = System.getProperty( "cswUrlSql" );
        System.out.println("Check if CSW to test with URL '" + url + "' is available!");
        try {
            InputStream postBody = CswBkg1SqlIT.class.getResourceAsStream( "testGetRecordsRequest.xml" );
